...
## VSB
If we are interested in different regions, it is not easy to adapt the analysis. Let's look at Vancouver School Board, who is struggling to deal with changing enrolment patterns in their schools. The above analysis of central vs outer regions in the City of Vancouver touches on some of the problems, but overall the City of Vancouver does not match the geography of SD 39. To remedy this, let's just re-run the overview analysis using the correct region.
