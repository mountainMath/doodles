...
grid.arrange(
  ...
  bottom="Canada Census 2006, 2011, 2016 via cancensus & CensusMapper.ca")
```
Here we notice that the trend of declining population of 5 to 14 year olds has been reversed, although the share of children in that age bracket out of the total population still declined.
