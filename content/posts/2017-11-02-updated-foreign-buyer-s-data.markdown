...
categories:
  - Vancouver
tags: []
description: "Foreign buyer's data is back!"
...
We take a closer look at the top 8 municipalities in terms to total transaction values by foreign buyers in 2017 thus far. Data is not available for all months due to at times small number of transactions. Next to the municipalities we already looked at above this selection criterion also yields Coquitlam, Victoria, Saanich and the Township of Langley.
